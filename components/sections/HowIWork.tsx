        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
          <div className="space-y-4">
            <h2 className="text-3xl md:text-5xl font-semibold tracking-tight text-[#242424] dark:text-white uppercase">
              How I <span className="text-[#00d4ff]">Work</span>
            </h2>
          ...
          <div className="text-xs font-black uppercase text-[#00d4ff] tracking-widest mb-4">Process</div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((s, i) => (
            ...
            >
              ...
              {/* Icon */}
              <div className="w-12 h-12 mb-6 bg-[#f2f2f2] dark:bg-[#252525] border border-gray-200 dark:border-gray-700 flex items-center justify-center text-[#00d4ff] group-hover:bg-gradient-to-r from-[#e10098] via-[#5c2d91] to-[#00d4ff] group-hover:text-white transition-colors">
                <s.icon size={22} />
              </div>

              <h3 className="text-lg font-bold uppercase tracking-tight text-[#242424] dark:text-white mb-3 group-hover:text-[#00d4ff] transition-colors">
                {s.title}
              </h3>
