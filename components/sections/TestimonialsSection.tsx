        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
          <div className="space-y-4">
            <h2 className="text-3xl md:text-5xl font-semibold tracking-tight text-[#242424] dark:text-white uppercase">
              Client <span className="text-[#00d4ff]">Feedback</span>
            </h2>
          ...
          <div className="text-xs font-black uppercase text-[#00d4ff] tracking-widest mb-4">Testimonials</div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              className="bg-[#f2f2f2] dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 p-6 flex flex-col gap-4 hover:border-[#00d4ff] dark:hover:border-[#00d4ff] transition-colors group"
            >
              <Quote className="text-[#00d4ff] w-6 h-6 opacity-70" />
              <p className="text-sm text-[#505050] dark:text-gray-300 leading-relaxed font-medium flex-grow">
                "{t.review}"
              </p>
              <div className="flex items-center gap-3 pt-2 border-t border-gray-200 dark:border-gray-700">
                <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#e10098] via-[#5c2d91] to-[#00d4ff] flex items-center justify-center text-white text-xs font-black shrink-0">
                  {t.avatar}
                </div>
                <div>
