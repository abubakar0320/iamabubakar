...
const categoryMeta: Record<string, { icon: React.ElementType; color: string }> = {
  "WEB DEVELOPMENT SERVICES":   { icon: Code2,         color: "#e10098" },
  "DEPLOYMENT & HOSTING SERVICES": { icon: Server,     color: "#00d4ff" },
  "SEO & ANALYTICS SERVICES":   { icon: Search,        color: "#5c2d91" },
  ...
  return (
    <div className="bg-white dark:bg-[#111] min-h-screen text-[#242424] dark:text-white font-sans">
      ...
      <section className="relative overflow-hidden bg-[#0d0d0d] py-20 md:py-32 px-4 md:px-12 xl:px-20">
        ...
        <div className="relative z-20 max-w-[1600px] mx-auto">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <div className="text-xs font-black uppercase text-[#00d4ff] tracking-widest mb-4">What I Offer</div>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 bg-gradient-to-r from-[#e10098] via-[#5c2d91] to-[#00d4ff] text-white font-bold px-6 py-3 hover:bg-gradient-to-r from-[#c00082] via-[#4a2474] to-[#00b8cc] transition-colors text-sm uppercase tracking-widest"
              >
      ...
      <section className="py-20 md:py-24 px-4 md:px-12 xl:px-20 bg-[#f2f2f2] dark:bg-[#0d0d0d] border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-[1600px] mx-auto">
          <div className="mb-14 space-y-3">
            <div className="text-xs font-black uppercase text-[#00d4ff] tracking-widest">Workflow</div>
      ...
      <section className="py-20 md:py-24 px-4 md:px-12 xl:px-20 bg-white dark:bg-[#111] border-t border-gray-100 dark:border-gray-800">
        <div className="max-w-[1600px] mx-auto">
          <div className="mb-14 space-y-3">
            <div className="text-xs font-black uppercase text-[#00d4ff] tracking-widest">Advantages</div>
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight uppercase text-[#242424] dark:text-white">
      ...
      <section className="py-20 md:py-24 px-4 md:px-12 xl:px-20 bg-[#f2f2f2] dark:bg-[#0d0d0d] border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-[1600px] mx-auto">
          <div className="mb-14 space-y-3">
            <div className="text-xs font-black uppercase text-[#00d4ff] tracking-widest">Transparent Pricing</div>
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight uppercase text-[#242424] dark:text-white">
              Investment <span className="text-[#00d4ff]">Plans</span>
            </h2>
            <p className="text-sm text-[#505050] dark:text-gray-400 max-w-xl font-medium">
            ...
            {dbPricingPlans.map((plan: any, index: number) => (
              <motion.div
                ...
                className={cn(
                  ...
                  plan.recommended
                    ? "bg-gradient-to-r from-[#e10098] via-[#5c2d91] to-[#00d4ff] text-white border-[#00d4ff] shadow-2xl shadow-fuchsia-500/20 scale-[1.02]"
                    : "bg-white dark:bg-[#1a1a1a] border-gray-200 dark:border-gray-800 hover:border-[#00d4ff] dark:hover:border-[#00d4ff]"
                )}
              >
                {plan.recommended && (
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
            ...
            <div className="lg:w-[360px] shrink-0">
              <div className="lg:sticky lg:top-28 space-y-5">
                ...
                <h2 className="text-3xl md:text-4xl font-semibold tracking-tight uppercase text-[#242424] dark:text-white">
                  Common <span className="text-[#00d4ff]">Questions</span>
                </h2>
                ...
                <div key={index}>
                  ...
                  >
                    <span className={cn(
                      ...
                      openFaq === index ? "text-[#00d4ff]" : "text-[#242424] dark:text-white group-hover:text-[#00d4ff]"
                    )}>
                      {faq.question}
                    </span>
                    <span className="shrink-0 w-7 h-7 border border-gray-200 dark:border-gray-700 flex items-center justify-center text-[#505050] dark:text-gray-400 group-hover:border-[#00d4ff] group-hover:text-[#00d4ff] transition-colors">
