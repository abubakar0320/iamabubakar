      ...
      <section className="bg-[#f2f2f2] dark:bg-[#1a1a1a] py-12 md:py-20 px-4 md:px-12 xl:px-20 border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-[1600px] mx-auto">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <h1 className="text-3xl md:text-5xl font-semibold mb-6 tracking-tight uppercase">Terms <span className="text-[#00d4ff] dark:text-[#4da3ff]">of Use</span></h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-12 text-sm md:text-base">
            <section className="space-y-6">
              <h2 className="text-2xl font-semibold flex items-center gap-3">
                <Scale className="text-[#00d4ff]" size={24} /> 1. Operational Framework
              </h2>
            ...
            <section className="space-y-6 pt-10 border-t border-gray-100 dark:border-gray-800">
              <h2 className="text-2xl font-semibold flex items-center gap-3">
                <Shield className="text-[#00d4ff]" size={24} /> 2. Intellectual Property Node
              </h2>
              <p className="text-[#505050] dark:text-gray-400 leading-relaxed">
              ...
              <ul className="space-y-3 text-sm font-bold text-gray-600 dark:text-gray-300 uppercase tracking-tight list-none ml-2">
                <li className="flex items-start gap-3"><CheckCircle size={14} className="text-[#00d4ff] mt-1 shrink-0" /> Unauthorized reproduction of source code is strictly prohibited.</li>
                <li className="flex items-start gap-3"><CheckCircle size={14} className="text-[#00d4ff] mt-1 shrink-0" /> Commercial use of portfolio assets requires explicit authorization.</li>
              </ul>
            </section>

            <section className="space-y-6 pt-10 border-t border-gray-100 dark:border-gray-800">
              <h2 className="text-2xl font-semibold flex items-center gap-3">
                <Zap className="text-[#00d4ff]" size={24} /> 3. Service Deployment Protocols
              </h2>
              <p className="text-[#505050] dark:text-gray-400 leading-relaxed">
            ...
            <section className="space-y-6 pt-10 border-t border-gray-100 dark:border-gray-800">
              <h2 className="text-2xl font-semibold flex items-center gap-3">
                <FileText className="text-[#00d4ff]" size={24} /> 4. Liability &amp; System Integrity
              </h2>
              <p className="text-[#505050] dark:text-gray-400 leading-relaxed">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-gradient-to-r from-[#e10098] via-[#5c2d91] to-[#00d4ff] p-8 text-white">
               ...
               <p className="text-pink-100 text-sm mb-8 italic">Version 2.4.0 • Authorized Deployment</p>
            ...
            <div className="p-8 border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1a1a1a] group">
               ...
               <Link href="/privacy" className="text-[#00d4ff] dark:text-[#4da3ff] font-bold text-xs uppercase tracking-widest hover:underline flex items-center gap-2">
