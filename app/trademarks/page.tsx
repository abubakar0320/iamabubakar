      ...
      <section className="bg-[#f2f2f2] dark:bg-[#1a1a1a] py-12 md:py-20 px-4 md:px-12 xl:px-20 border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-[1600px] mx-auto">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <h1 className="text-3xl md:text-5xl font-semibold mb-6 tracking-tight uppercase">Brand <span className="text-[#0067b8] dark:text-[#4da3ff]">& Trademarks</span></h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-12">
            <section className="space-y-6">
              <h2 className="text-2xl font-semibold flex items-center gap-3 text-[#242424] dark:text-white">
                <BadgeCheck className="text-[#0067b8]" size={24} /> 1. Registered Assets
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                 <div className="p-4 bg-gray-50 dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 flex items-center gap-3">
                    <div className="w-2 h-2 bg-[#0067b8] rounded-full"></div>
            ...
            <section className="space-y-6 pt-10 border-t border-gray-100 dark:border-gray-800">
              <h2 className="text-2xl font-semibold flex items-center gap-3 text-[#242424] dark:text-white">
                <ShieldCheck className="text-[#0067b8]" size={24} /> 2. Visual Identity Node (Logo)
              </h2>
            ...
            <section className="space-y-6 pt-10 border-t border-gray-100 dark:border-gray-800">
              <h2 className="text-2xl font-semibold flex items-center gap-3 text-[#242424] dark:text-white">
                <Copyright className="text-[#0067b8]" size={24} /> 3. Attribution Protocols
              </h2>
              <p className="text-[#505050] dark:text-gray-400 leading-relaxed">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-[#0067b8] p-8 text-white">
               ...
               <p className="text-blue-100 text-sm mb-8">Trademarks are protected under global intellectual property protocols.</p>
            ...
            <div className="p-8 border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1a1a1a] group">
               ...
               <Link href="/terms" className="text-[#0067b8] dark:text-[#4da3ff] font-bold text-xs uppercase tracking-widest hover:underline flex items-center gap-2">
