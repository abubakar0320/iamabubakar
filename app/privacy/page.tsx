      ...
      <section className="bg-[#f2f2f2] dark:bg-[#1a1a1a] py-12 md:py-20 px-4 md:px-12 xl:px-20 border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-[1600px] mx-auto">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <h1 className="text-3xl md:text-5xl font-semibold mb-6 tracking-tight">Privacy <span className="text-[#0067b8] dark:text-[#4da3ff]">& Cookies</span></h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-12">
            <section className="space-y-6">
              <h2 className="text-2xl font-semibold flex items-center gap-3">
                <Lock className="text-[#0067b8]" size={24} /> Data Collection Protocols
              </h2>
              ...
              <ul className="space-y-4 text-sm font-medium text-gray-600 dark:text-gray-300 uppercase tracking-tight list-none ml-2">
                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-[#0067b8] rounded-full" /> Identity nodes (Name, Email)</li>
                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-[#0067b8] rounded-full" /> Communication streams (Inquiry messages)</li>
                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-[#0067b8] rounded-full" /> Transaction hashes (Order IDs, Payment logs)</li>
              </ul>
            </section>

            <section className="space-y-6 pt-10 border-t border-gray-100 dark:border-gray-800">
              <h2 className="text-2xl font-semibold flex items-center gap-3">
                <Cookie className="text-[#0067b8]" size={24} /> Cookie Architecture
              </h2>
              <p className="text-[#505050] dark:text-gray-400 leading-relaxed">
            ...
            <section className="space-y-6 pt-10 border-t border-gray-100 dark:border-gray-800">
              <h2 className="text-2xl font-semibold flex items-center gap-3">
                <Shield className="text-[#0067b8]" size={24} /> Security Commitment
              </h2>
              <p className="text-[#505050] dark:text-gray-400 leading-relaxed">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-[#0067b8] p-8 text-white">
               ...
               <p className="text-blue-100 text-sm mb-8">This policy was last synchronized on May 2026. Global updates propagate automatically.</p>
            ...
            <div className="p-8 border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1a1a1a]">
               ...
               <a href="mailto:hello@iamabubakar.com" className="text-[#0067b8] dark:text-[#4da3ff] font-bold text-xs uppercase tracking-widest hover:underline flex items-center gap-2">
