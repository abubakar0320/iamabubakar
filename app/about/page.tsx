...
const languages = [
  { lang: "Punjabi", level: "Native",      cefr: null,  pct: 100, color: "#0067b8" },
  { lang: "Urdu",    level: "Proficient",  cefr: "C2",  pct: 98,  color: "#107c10" },
  { lang: "English", level: "Independent", cefr: "B2–C1", pct: 72, color: "#d83b01" },
];

const recommendations = [
  { name: "Prof. Shehzad Nazir",           role: "Assistant Professor",  phone: "(+92) 313-4152107", initials: "SN", color: "#0067b8" },
  { name: "Prof. Dr. Muhammad Usman Younas", role: "Head of Dept. CS",   phone: "(+92) 305-4646932", initials: "MY", color: "#107c10" },
  { name: "Prof. Hassan Iftikhar",          role: "Assistant Professor",  phone: "(+92) 308-0637587", initials: "HI", color: "#d83b01" },
  ...
  return (
    <div className="bg-white dark:bg-[#111] min-h-screen text-[#242424] dark:text-white font-sans">
        ...
        <div className="relative z-20 max-w-[1600px] mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex-1 max-w-2xl">
              <div className="text-xs font-black uppercase text-[#0067b8] tracking-widest mb-4">About Me</div>
              <h1 className="text-4xl md:text-6xl font-semibold tracking-tight text-white mb-4 leading-tight">
                Abu Bakar <span className="text-[#0067b8]">Siddique</span>
              </h1>
              <div className="text-base md:text-lg text-[#0067b8] font-black uppercase tracking-widest mb-6">
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/contact" className="inline-flex items-center gap-2 bg-[#0067b8] text-white font-bold px-6 py-3 hover:bg-[#005da6] transition-colors text-sm uppercase tracking-widest">
        ...
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-20">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="space-y-2">
              <div className="text-xs font-black uppercase text-[#0067b8] tracking-widest">Professional Overview</div>
              <h2 className="text-3xl md:text-4xl font-semibold tracking-tight uppercase text-[#242424] dark:text-white">
                Who I <span className="text-[#0067b8]">Am</span>
              </h2>
            </div>
            ...
            <Link href="/contact">
              <button className="inline-flex items-center gap-2 bg-[#0067b8] text-white font-semibold py-3 px-8 hover:bg-[#005da6] transition-colors text-sm uppercase tracking-widest">
          ...
          <div className="lg:col-span-5 space-y-10">
            <div className="space-y-2">
              <div className="text-xs font-black uppercase text-[#0067b8] tracking-widest">Technical Stack</div>
            ...
            {["Frontend", "Backend", "Other"].map((cat) => {
              ...
              return (
                <div key={cat} className="space-y-5">
                  <div className="text-[10px] font-black uppercase tracking-widest text-[#0067b8] flex items-center gap-2">
                    <div className="w-4 h-0.5 bg-[#0067b8]" /> {cat}
                  </div>
                  {catSkills.map((skill: any) => (
                    <div key={skill.name}>
                      <div className="flex justify-between items-center mb-1.5">
                        <span className="text-xs font-bold uppercase tracking-wide text-[#242424] dark:text-white">{skill.name}</span>
                        <span className="text-[10px] font-black text-[#0067b8] tabular-nums">{skill.level}%</span>
                      </div>
      ...
      <section className="py-20 md:py-24 px-4 md:px-12 xl:px-20 bg-[#f2f2f2] dark:bg-[#0d0d0d] border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-[1600px] mx-auto">
          <div className="mb-14 space-y-3">
            <div className="text-xs font-black uppercase text-[#0067b8] tracking-widest">Principles</div>
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight uppercase text-[#242424] dark:text-white">
              What I <span className="text-[#0067b8]">Believe In</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((v, i) => (
              <motion.div key={v.title} initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                className="flex items-start gap-5 p-6 bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 hover:border-[#0067b8] dark:hover:border-[#0067b8] transition-colors group">
                <div className="w-11 h-11 shrink-0 bg-[#f2f2f2] dark:bg-[#252525] border border-gray-200 dark:border-gray-700 flex items-center justify-center text-[#0067b8] group-hover:bg-[#0067b8] group-hover:text-white transition-colors">
                  <v.icon size={20} />
                </div>
                <div>
                  <h3 className="text-sm font-black uppercase tracking-tight text-[#242424] dark:text-white mb-1 group-hover:text-[#0067b8] transition-colors">{v.title}</h3>
      ...
      <section className="py-20 md:py-24 px-4 md:px-12 xl:px-20 bg-white dark:bg-[#111] border-t border-gray-100 dark:border-gray-800">
        <div className="max-w-[1600px] mx-auto">
          <div className="mb-14 space-y-3">
            <div className="text-xs font-black uppercase text-[#0067b8] tracking-widest">Work History</div>
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight uppercase text-[#242424] dark:text-white">
              Experience <span className="text-[#0067b8]">Timeline</span>
            </h2>
          </div>
      ...
      <section className="py-20 md:py-24 px-4 md:px-12 xl:px-20 bg-[#f2f2f2] dark:bg-[#0d0d0d] border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-[1600px] mx-auto">
          <div className="mb-14 space-y-3">
            <div className="text-xs font-black uppercase text-[#0067b8] tracking-widest">Academic Background</div>
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight uppercase text-[#242424] dark:text-white">
              <GraduationCap className="inline mr-2 text-[#0067b8]" size={30} />
              Education
            </h2>
          </div>
            ...
            {finalEducation.map((edu: any, i: number) => (
              <motion.div key={i} initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="p-7 space-y-3">
                  ...
                  <h3 className="text-base font-bold text-[#242424] dark:text-white group-hover:text-[#0067b8] transition-colors leading-snug">{edu.degree}</h3>
                  <div className="text-xs font-bold uppercase tracking-wide text-[#0067b8]">{edu.institution}</div>
                  {edu.cgpa && (
      ...
      <section className="py-20 md:py-24 px-4 md:px-12 xl:px-20 bg-white dark:bg-[#111] border-t border-gray-100 dark:border-gray-800">
        <div className="max-w-[1600px] mx-auto">
          <div className="mb-14 space-y-3">
            <div className="text-xs font-black uppercase text-[#0067b8] tracking-widest">Credentials</div>
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight uppercase text-[#242424] dark:text-white">
      ...
      <section className="py-20 md:py-24 px-4 md:px-12 xl:px-20 bg-[#f2f2f2] dark:bg-[#0d0d0d] border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-[1600px] mx-auto">
          <div className="mb-14 space-y-3">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight uppercase text-[#242424] dark:text-white">
              <Languages className="inline mr-2 text-[#0067b8]" size={28} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {finalLanguages.map((l: any, i: number) => (
              <motion.div key={l.lang} initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="flex items-center justify-between mb-5">
                  <div className="text-xl font-black text-[#242424] dark:text-white group-hover:text-[#0067b8] transition-colors">{l.lang}</div>
                  {l.cefr ? (
            ...
            {finalRecommendations.map((rec: any, i: number) => (
              <motion.div key={rec.name} initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-bold text-[#242424] dark:text-white group-hover:text-[#0067b8] transition-colors leading-snug mb-1">{rec.name}</h3>
                ...
                <a href={`tel:${rec.phone.replace(/\s/g, "")}`}
                  className="flex items-center gap-2 text-xs font-bold text-[#505050] dark:text-gray-400 hover:text-[#0067b8] transition-colors border-t border-gray-200 dark:border-gray-700 pt-4">
