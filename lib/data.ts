...
export const projects = [
  {
    ...
    description: "A fully responsive React + Tailwind frontend for FileHub — a collaborative platform where authenticated users can request help and share solutions via files and captions.",
  ...
  },
  {
    ...
    category: "PHP",
    image: "https://images.unsplash.com/photo-1577083165633-14ebcdb0f658?q=80&w=2072&auto=format&fit=crop",
    live: "#",
    github: "https://github.com/abubakar0320/Jamia-shere-rabbani",
  },
  {
    id: 3,
    title: "Special Lady (AI Companion)",
    description: "Voice-interactive AI companion for emotional modeling and multi-model research, focusing on natural language interaction.",
  ...
  },
  {
    ...
    description: "A robust e-commerce platform for clothing stores with product management and user authentication.",
    tech: ["PHP", "MySQL", "jQuery", "CSS"],
    category: "PHP",
